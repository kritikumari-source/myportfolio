...
//           style={{ boxShadow: '1px 16px 10px -5px rgba(0,0,0,0.5)'}}
//         >
//           Open Resume
//         </a>
//       </div>
...
//         </p>
//         <p>
//           <FaGithub /> <a href="https://github.com/kritikumari-source">github.com/kriti</a>
//         </p>
...
const Resume = () => {
  return (
    <div className="resume-container container pt-4">
      {/* About Me - Card Version of Accordion */}
      ...
      <div className="row g-4 mb-5 justify-content-center">
        ...
        {/* Technical Skills */}
        <div className="col-md-4 col-lg-4" style={{ boxShadow: '1px 16px 10px -5px rgba(0,0,0,0.5)' }}>
           {/* <div className="card h-100 shadow-sm border-primary">  */}
           <div className="card h-100 shadow-sm border-seagreen">
            <div className="card-header bg-seagreen d-flex align-items-center">
